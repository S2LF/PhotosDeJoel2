...
final class Version20200720141255 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `base` (id INT AUTO_INCREMENT NOT NULL, titre_du_site_header VARCHAR(255) DEFAULT NULL, texte_header LONGTEXT DEFAULT NULL, mot_page_accueil VARCHAR(255) DEFAULT NULL, photo_accueil_path VARCHAR(255) DEFAULT NULL, text_footer VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
